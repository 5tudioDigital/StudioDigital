...
var _2ClickIframePrivacy = new function() {
    ...
    function r(e, n, i, t) {
        e.parentNode.insertBefore(n, e), n.className = "privacy-msg privacy-" + i + "-msg", n.style.width = e.clientWidth + "px", n.style.height = e.clientHeight + "px", n.innerHTML = t + '<a href="#foo" onclick="_2ClickIframePrivacy.EnableContent(\'' + i + "'); return false;\">" + o.showContentLabel + "</a>", o.enableCookies && (n.innerHTML = n.innerHTML + '<br /><div class="w-checkbox checkbox-field"> <input type="checkbox" name="remind-\'' + i + "'\" /> <label>" + o.rememberChoiceLabel + "</label></div>"), o.privacyPolicyUrl && (n.innerHTML = n.innerHTML + '<br /><a href="' + o.privacyPolicyUrl + '">' + o.privacyPolicyLabel + "</a>"), n.innerHTML = "<p>" + n.innerHTML + "</p>", n.appendChild(e)
    }
    var o = {
        enableCookies: !0,
        useSessionCookie: !0,
